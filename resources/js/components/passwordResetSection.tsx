            ...
            <div className="flex lg:w-[75%] w-full items-center justify-center py-[100px] shadow-xl px-10 sm:px-20">
                <div className="w-full">
                    ...
                    <form action="#" className="mt-10">
                        <div>
                            <input type="text" placeholder="New Password" name="password" className="p-4 border-b-1 border-gray-300 outline-0 w-full"/>
                        ...
                        <button className="relative mt-8 inline-block overflow-hidden bg-gradient-to-r from-[#ffba00] to-[#ff6c00] px-7 py-2 w-full font-semibold text-white uppercase transition-all duration-300 ease-in-out before:absolute before:top-0 before:left-[-150%] before:h-full before:w-full before:skew-x-[40deg] before:bg-black before:opacity-0 before:transition-all before:duration-300 before:ease-in-out before:content-[''] hover:before:left-[150%] hover:before:opacity-30">Reset</button>
                    </form>
                </div>
            </div>
        </>

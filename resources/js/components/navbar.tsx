...
export default function Navbar() {
    ...
    return (
        ...
        bg-white shadow-[0_10px_30px_rgba(0,0,0,0.1)]`}>
            <div className={`flex justify-between items-center px-10 py-2 md:py-4 max-w-[1200px] mx-auto transition-all duration-300`}>
                <div>
                ...
                <button className="md:hidden cursor-pointer" onClick={() => setShowMobile(!showMobile)}>
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
            ...
            <AnimatePresence>
                { showMobile && (
                    <motion.div className="md:hidden overflow-hidden" key={"mobilebar"} initial={{ height: 0 }} animate={{ height: "auto"}} exit={{ height: 0 }} transition={{ duration: 0.4, ease: "easeInOut"}}>
                        <ul className="px-10">
                            <li><Link href="/" className={`text-[12px] mt-2 py-2 block px-5 font-bold hover:text-[#ffba00] transition-all duration-300 ${linkClasses('/')}`}>HOME</Link></li>
                            <li><Link href="/shop" className={`text-[12px] py-2 block px-5 font-bold hover:text-[#ffba00] transition-all duration-300 ${linkClasses('/shop')}`}>SHOP</Link></li>
                            <li><Link href="/contact" className={`text-[12px] py-2 block px-5 font-bold hover:text-[#ffba00] transition-all duration-300 ${linkClasses('/contact')}`}>CONTACT</Link></li>
                            <li><Link href="/about" className={`text-[12px] py-2 block px-5 font-bold hover:text-[#ffba00] transition-all duration-300 ${linkClasses('/about')}`}>ABOUT</Link></li>
                            <div className="flex justify-end items-center">
                                ...
                                <li className="ml-5 my-3 pb-3 pt-4">
                                    <button className="cursor-pointer" onClick={() => setShowSearch(true)}>
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            fill="none"
                ...
                {showSearch && (
                    <motion.div key={"searchbar"} initial={{ height: 0 }} animate={{ height: "auto"}} exit={{ height: 0 }} transition={{ duration: 0.4, ease: "easeInOut"}} className={`w-full bg-gradient-to-r from-[#ff6c00] to-[#ffba00] overflow-hidden`}>
